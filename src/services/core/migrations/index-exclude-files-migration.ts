 ...
 */
export class IndexExcludeFilesMigration implements ISettingsMigration {
	readonly id = 'index.excludeFiles';

	readonly description = 'Migrate the deprecated `index.ignoreFolders` setting to the glob-based `index.excludeFiles` setting.';
