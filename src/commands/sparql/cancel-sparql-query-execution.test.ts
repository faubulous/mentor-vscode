...
let mockCancelQuery: ReturnType<typeof vi.fn<(...args: unknown[]) => unknown>>;
...
import { cancelSparqlQueryExecution } from '@src/commands/sparql/cancel-sparql-query-execution';
