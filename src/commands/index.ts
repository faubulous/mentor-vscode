...
export { sortDocumentAlphabetically } from './sort-document-alphabetically';
export { sortDocumentByType } from './sort-document-by-type';
export { sortDocumentSemantically } from './sort-document-semantically';
