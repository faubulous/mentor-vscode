...
- Each webview has a bundle built into `dist/` (e.g. `sparql-connection-view.js`). The controller references it via `componentPath` and the factory generates the final HTML.
