...
export const SETTINGS_METADATA: Record<string, SettingMetadata> = {
	...
	"sorting.typeSortingOptions": {
		...
		description: "Options for the priority-based sort strategy used when sorting documents by type. See https://github.com/faubulous/mentor-rdf-serializers/blob/main/docs/sorting.md#priority for reference.",
