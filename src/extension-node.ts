...
export async function activate(context: vscode.ExtensionContext) {
	...
	// Register the Node.js-specific language client factory.
	// This creates language clients that use IPC to communicate with language servers
	// running as Node.js child processes, enabling CORS-free HTTP and terminal access.
	container.registerInstance(ServiceToken.LanguageClientFactory, createNodeLanguageClient);
